document.addEventListener("DOMContentLoaded", function() {
    ...
    let timechart;
    let prevLevel;
    let timeLimit = 5000; //change this to adjust time showing modal
    ...
    // Function to check and show flood alerts
    function checkFloodLevel(level) {
        if (level === 2) {
            document.getElementById('alertMessage').innerHTML = 'The water level is at 2 feet.';
            openModal();
        } else if (level === 4) {
            document.getElementById('alertMessage').innerHTML = 'The water level is at 4 feet.';
            openModal();
        } else if (level >= 6) {
            document.getElementById('alertMessage').innerHTML = 'The water level is at 6 feet or higher. Take immediate action!';
            openModal();
        }
    }
    ...
    function renderFloodLevelChart(data) {
        ...
        if(prevLevel!=data.current_level){
            checkFloodLevel(data.current_level);
            prevLevel=data.current_level;
        }
